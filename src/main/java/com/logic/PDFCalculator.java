...
public class PDFCalculator
{
     ...
     * @throws PDFException
     */
    public Paragraph addFrontPageInfo(String author,
            String headerTitle, Customer customer, Order order) throws PDFException
    {
        try
        {
            ...
            String totalPrice = String.format("%.2f", order.getTotal_price()) + "kr.";
            ...
            addFogImage(para);
            addEmptyLine(para, 2);
            para.add(new Paragraph("Generated by: " + author + ", " + new Date(), smallBold));
            addEmptyLine(para, 1);
            para.add(new Paragraph("Ordre ID#: " + orderId, smallBold));
            para.add(new Paragraph("Køber: " + customerName, smallBold));
            para.add(new Paragraph("Samlet købspris: " + totalPrice, smallBold));
            addEmptyLine(para, 1);
            para.add(new Paragraph("Købers kontaktinformation:"
                    + "\nTelefon: " + customerPhone
                    + "\nEmail: " + customerEmail, smallBold));
            para.add(new Paragraph("Leveringsadresse: " + customerAddress, smallBold));
            
            return para;
        }
        catch (BadElementException ex)
        {
            throw new PDFException("Fejl i addFrontPageInfo. BadElementException");
        }
        catch (IOException ex)
        {
            throw new PDFException("Fejl i addFrontPageInfo. IOException");
        }
    }
    ...
    public Paragraph addBillTable(java.util.List<String> stringList) throws PDFException
    {
        ...
        {
            Paragraph para = new Paragraph();
            PdfPTable billTable = generateTable(stringList);
            para.add(billTable);
            return para;
        }
        catch (DocumentException ex)
        {
            throw new PDFException("Fejl i addBillTable. DocumentException");
        }
    }
    ...
    {
        String imagePath = "img" + separator + "index.jpg";
