...
public class PDFCalculator
{
    ...
    public Paragraph addFrontPageInfo(String author,
            String headerTitle, Customer customer, Order order) throws BadElementException, IOException
    {
    ...
    public Paragraph addBillTable(java.util.List<String> stringList) throws DocumentException
    {
        Paragraph para = new Paragraph();
