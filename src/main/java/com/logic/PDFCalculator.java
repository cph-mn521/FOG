...
public class PDFCalculator
{
    ...
    public Paragraph generateBill(String author, java.util.List<String> stringList,
            String headerTitle, Customer customer, Order order) throws DocumentException, BadElementException, IOException
    {
        ...
        para1.add(new Paragraph("Køber: " + customerName, smallBold));
        para1.add(new Paragraph("Samlet købspris: " + totalPrice, smallBold));
        addEmptyLine(para1, 1);
        para1.add(new Paragraph("Købers kontaktinformation:"
                + "\nTelefon: " + customerPhone
                + "\nEmail: " + customerEmail, smallBold));
        para1.add(new Paragraph("Leveringsadresse: " + customerAddress, smallBold));
