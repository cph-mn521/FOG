...
public class PDFCalculator
{
     ...
     */
    public Paragraph generateBill(String author, java.util.List<String> stringList, String headerTitle, int orderId) throws DocumentException
    {
        Paragraph para1 = new Paragraph();
        addEmptyLine(para1, 1);
        para1.add(new Paragraph(headerTitle, catFont));
        addEmptyLine(para1, 1);
        para1.add(new Paragraph("Generated by: " + author + ", " + new Date(), smallBold));
        para1.add(new Paragraph("Bill ID#: " + orderId));
     ...
     * language, the import used (iText), the author and the creator.
     * This metadata can be viewed by using PDF viewing app by accessing the
     * file properties.
     * 
