...
//    public void generatePDF(Map<Component, Integer> bom, String author)
    ...
    private static void addBill(Document document, String author, Map<Component, Integer> bom) throws DocumentException
    {
        ...
        generateTable(para1, bom);
        
        document.add(para1);
    }
    
    private static void generateTable(Paragraph para, Map<Component, Integer> bom) throws BadElementException
    {
...
//        t.setBorderWidth(1);
        ...
        cell = new PdfPCell(new Phrase("Beskrivelse"));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(cell);

        cell = new PdfPCell(new Phrase("Hjælpetext"));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(cell);

        cell = new PdfPCell(new Phrase("Længde"));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(cell);
        
        cell = new PdfPCell(new Phrase("Bredde"));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(cell);
        
        cell = new PdfPCell(new Phrase("Højde"));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(cell);
        
        cell = new PdfPCell(new Phrase("Pris pr. styk"));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(cell);
        
        cell = new PdfPCell(new Phrase("Antal"));
        cell.setHorizontalAlignment(Element.ALIGN_CENTER);
        table.addCell(cell);
